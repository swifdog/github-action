    ...
    return {
        projects: {
            ...
            packets: {
                ...
                updateImage: function (projectId, id, image, callback) {
                    request('/projects/' + projectId + '/packets/' + id, {image}, 'PATCH', callback);
                },
            ...
            registryCredentials: {
                list: function (projectId, callback) {
                    get('/projects/' + projectId + "/registryCredentials", callback)
                },
                create: function (projectId, hostname, username, email, password, callback) {
                    request('/projects/' + projectId + '/registryCredentials', {hostname, username, email, password}, 'POST', callback);
                },
            }
        },
    };
